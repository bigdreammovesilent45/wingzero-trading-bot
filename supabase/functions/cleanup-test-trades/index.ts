...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`🧹 Cleaning up test trades for user: ${user.id}`)
    ...
    console.log(`✅ Closed ${updatedTrades?.length || 0} test trades`)
    ...
    console.error('❌ Error cleaning up test trades:', error)
    return new Response(
